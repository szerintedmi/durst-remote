...
#define AP_DEFAULT_SSID "ESP32-WiFi-Setup"
#define AP_DEFAULT_PASS "eljenapartunk"

#define MESH_SSID "DurstMesh"
...
{
public:
    WifiPortal(const char *apSsid = AP_DEFAULT_SSID,
               const char *apPass = AP_DEFAULT_PASS,
